...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/04/23 11:44:35 by crigonza          #+#    #+#              #
#    Updated: 2022/05/03 18:16:47 by crigonza         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	=	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
		ft_isprint.c ft_memcpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c \
...
BONUS	=	ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstlast_bonus.c \
			ft_lstadd_back_bonus.c ft_lstsize_bonus.c ft_lstdelone_bonus.c \
